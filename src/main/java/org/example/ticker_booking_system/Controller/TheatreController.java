...
import org.example.ticker_booking_system.DTO.TheatreRequestDTO;
import org.example.ticker_booking_system.Service.TheatreService;
...
public class TheatreController {
    ...
    public ResponseEntity createTheatre(@RequestBody TheatreRequestDTO theatreRequestDTO)
    {
        return ResponseEntity.ok(theatreService.saveTheatre(theatreRequestDTO.getName(),
                theatreRequestDTO.getAddress(), theatreRequestDTO.getCityId()));
    }
